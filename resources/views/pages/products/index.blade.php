...
@section('pages')
    <div class="container" style="max-width: 1500px">
        <!-- Page Header -->
        <div style="background-color: rgb(114, 58, 40)" class="card  mb-3 p-4">
            <div class="row">
                <div class="col-12 d-flex justify-content-between align-item-center ">
                    <h3 class=" card-title text-white d-flex align-items-center  m-0">Product List</h3>
                    <a href="{{ route('products.create') }}" class="btn btn-light btn-sm" title="Create New Product">
                        <i class="fa fa-plus mr-1"></i> Create New Product
                    </a>
                </div>
            </div>
        </div>
                        ...
                        <div class="col-md-5">
                            <div class="input-group">
                                <div class="input-group-prepend">
                                    <span
                                        class="input-group-text px-3 py-3 d-flex justify-content-center align-item-center bg-primary text-white">
